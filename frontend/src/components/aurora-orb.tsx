...
export function AuroraOrb({
  ...
  // Both states have a live level behind them — the microphone's while
  // listening, the reply's while speaking — so both drive the bars.
  const heights = (listening || speaking) && bands.length ? coreBars(bands) : RESTING;
