...
/**
 * Nine of the twenty-two languages Vec transcribes are written in Devanagari,
...
export const metadata: Metadata = {
  title: "Vec — Speak, and see it written",
  description:
    "A voice interface that listens in any Indian language and transcribes it with Sarvam Saaras.",
};
        ...
        <ConversationProvider>
          <TooltipProvider delayDuration={150}>
            ...
            <footer className="pointer-events-none fixed inset-x-0 bottom-0 z-30 px-6 py-5 text-center text-[0.72rem] tracking-wide text-ink-muted max-md:pb-24">
              Powered by Sarvam Saaras · 30 seconds per take
            </footer>
          </TooltipProvider>
        </ConversationProvider>
      </body>
